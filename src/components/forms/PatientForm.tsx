...
const PatientForm: FunctionComponent<PatientFormProps> = ({ patient, isEditForm }) => {
  ...
  const onUpdate = async (): Promise<void> => {
    ...
    try {
      ...
      addMessage({ text: 'Patient updated successfully', variant: 'success' })
    } catch (error) {
      addMessage({ text: 'Error updating patient', variant: 'danger' })
    }
  }
  ...
  const onCreatePatient = async (): Promise<void> => {
    ...
    try {
      ...
      addMessage({ text: 'Patient created successfully', variant: 'success' })
    } catch (error) {
      console.error(error)
      addMessage({ text: 'Error creating patient', variant: 'danger' })
    }
  }
