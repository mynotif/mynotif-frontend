...
const LogoutModal: React.FC<LogoutModalProps> = ({ show, onConfirm, onCancel }) => {
    ...
    return (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/30 backdrop-blur-sm">
            <div className="bg-gradient-to-br from-colorsecondary via-colorsecondary to-shade3 backdrop-blur-sm border border-gray-400 rounded-lg w-96 h-3/6 p-6 space-y-6 flex flex-col justify-between">
